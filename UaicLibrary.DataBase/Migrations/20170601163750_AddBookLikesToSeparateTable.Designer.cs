...
namespace UaicLibrary.DataBase.Migrations
{
    ...
    [Migration("20170601163750_AddBookLikesToSeparateTable")]
    partial class AddBookLikesToSeparateTable
    {
            ...
            modelBuilder.Entity("UaicLibrary.DataBase.Models.BookLikeDto", b =>
                {
                    ...
                    b.ToTable("BookLikeDto");
                });

            modelBuilder.Entity("UaicLibrary.DataBase.Models.BookReaderDto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SerialColumn);
